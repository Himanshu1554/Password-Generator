...
function generateSymbols(){
    let randomInt = getRndInteger(0, symbols.length);
...
async function copyContent(){
     ...
     // to make copyMsg span invisible after 2sec
     setTimeout(  () => {
...
generateBtn.addEventListener('click', () => {
    ...
    // start to generate the new password

    // remove old password while generating new
    password = "";
